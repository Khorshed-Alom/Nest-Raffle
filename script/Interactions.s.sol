...
contract FundSubscription is Script, CodeConstant{
    ...
    function run() public {
        FundSubscriptionionUsingConfig();
    }
}
...
contract AddConsumer is Script {
    ...
    function addConsummerUsingConfig(address mostRecentlyDeployed) public {
        HelperConfig helperConfig = new HelperConfig();
    ...
    function addConsumer(address contractToAddtoVrf, address vrfCoordinator, uint256 subId, address account) public {
        console.log("Adding comsumer contract", contractToAddtoVrf);
    ...
    function run() external {
        ...
        addConsummerUsingConfig(mostRecentlyDeployed);
    }
}